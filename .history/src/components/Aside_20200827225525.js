...
class Aside extends Component {
    ...
    constructor(props) {
        ...
        this.livraisonsSubItem= <div className="sub bg-dark">
                            ...
                            <Link to="/listelivraison" className="itemSubSideBar list-group-item bg-dark list-group-item-action"><font color="#55cdc4"> Listes Livraisons</font></Link>
                            <Link to="/stockerlivraison" className="itemSubSideBar list-group-item bg-dark list-group-item-action"><font color="#55cdc4"> Stocker Livraison </font></Link>                           
